...
static const long double STEFAN_BOLTZMANN_CONSTANT       = 5.670374419e-8;      // W/(m2 K4)
...
inline std::map<std::string, PROBLEM_NAME> Problem_Map{ { "LINESOURCE", PROBLEM_Linesource },
                                                        ...
                                                        { "PLUME_RADIATION", PROBLEM_PlumeRadiation } };
...
inline std::map<std::string, SOLVER_NAME> Solver_Map{ { "SN_SOLVER", SN_SOLVER },
                                                      ...
                                                      { "PLUME_DTM_SOLVER", PLUME_DTM_SOLVER } };

// Plume DTM backend
enum PLUME_BACKEND_NAME { PLUME_BACKEND_CPU, PLUME_BACKEND_CUDA };

inline std::map<std::string, PLUME_BACKEND_NAME> PlumeBackend_Map{ { "CPU", PLUME_BACKEND_CPU }, { "CUDA", PLUME_BACKEND_CUDA } };
